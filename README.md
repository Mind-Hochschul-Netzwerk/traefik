...
Copy [.env.example](./.env.example) and remove `.example` suffix. Change to your needs.
...
Copy [traefik-static.prod.yml.example](./conf/traefik-static.prod.yml.example) and remove `.example` suffix. Change to your needs.
